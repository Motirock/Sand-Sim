...
namespace utils {
    inline void vertexSpecification(GLuint *VAO, GLuint *VBO, GLuint *IBO, std::vector<GLfloat> *vertexData, std::vector<GLuint> *indexBufferData) {
        //Starts setting up GPU
        //VFO
